...
<br>
        <tr>
                ...
                <input type="text" class="box-input" name="username" placeholder="Mail de l'utilisateur" required>
        </tr>
</br>
<br>
        <tr>
                                            <legend> Mot de passe:</legend>
                    <input type="text" class="box-input" name="password" placeholder="Mot de passe">
        </tr>
</br>
